...
class DenseNetTrainer:
    """DenseNet trainer with GPU support and early stopping"""
    ...
    def train(self, train_loader, val_loader, max_epochs=200):
        """Main training loop"""
        print(f"🚀 Starting DenseNet training for {max_epochs} epochs...")
        ...
        for epoch in range(max_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                self.save_model(f"models/densenet/best_densenet_epoch_{epoch+1}.pth")
